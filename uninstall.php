...
$connection = new mysqli("localhost", "zestards_shopify", "pi#gyHnppiJH", "zestards_shopifylive_zestard_giftwrap");
$select_store = "select * from usersettings WHERE store_name= '" . $result->myshopify_domain . "'";
...
mail($result->email, "Zestard Application :: Zestard Gift Wrap", $uninstallation_follow_up_msg, $follow_up_headers);
mail("rdesoza98@gmail.com", "Zestard Application :: Zestard Gift Wrap", $uninstallation_follow_up_msg, $follow_up_headers);
...
if (count($fetchObject) == 0) {    
    mail("support@zestard.com", "Gift Wrap App Removed", $msg, $headers);
}
?>
